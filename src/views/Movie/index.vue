...
<style lang="scss" scoped>
    #content .movie_menu{
        ...
        z-index:10;
        align-items:center;
        .city_name{ margin-left: 20px; height:100%; line-height: 45px;box-sizing: border-box}
        .city_name.active{color: #ef4238; border-bottom: 2px #ef4238 solid} 
        .city_name.router-link-active{color: #ef4238; border-bottom: 2px #ef4238 solid;}
        .hot_swtich{display: flex;height:100%; line-height: 45px;
         ...
         .hot_item.router-link-active{ color: #ef4238; border-bottom: 2px #ef4238 solid;}
        };
        .search_entry{
            margin-right:20px;
            height:100%;
